...
public class Shell {
     ...
     * @throws InvalidCommandFormatException If an invalid action is encountered.
     */
    private static void changeCharSet(String param, Consumer<Character> consumer,
                                      String action)
            throws InvalidCommandFormatException {
        if (param == null || param.trim().isEmpty())
            throw new InvalidCommandFormatException(INVALID_ADD_MESSAGE);
            ...
            throw new InvalidCommandFormatException("Did not " + action +
    ...
    private static void res(String change) throws InvalidActionException,
        ...
        if (change == null)
            throw new InvalidCommandFormatException(INVALID_RESOLUTION_COMMAND_MESSAGE);
    ...
    private static void image(String path) throws InvalidCommandFormatException {
        try {
            if (path == null || path.isEmpty()) {
                throw new InvalidCommandFormatException(INVALID_IMAGE_MESSAGE);
            }
            Shell.loadedImage = new Image(path);
        } catch (IOException e) {
            //TODO Correct the exception here
            throw new InvalidActionException(INVALID_IMAGE_MESSAGE);
        }
    }
     ...
     */
    private static void output(String outputStream) throws InvalidCommandFormatException {
        if (outputStream == null)
            throw new InvalidCommandFormatException(INVALID_OUTPUT_COMMAND_MESSAGE);
        switch (outputStream) {
            case "console":
